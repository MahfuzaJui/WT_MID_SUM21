		...
		<fieldset>
			...
			<table>
				...
				<tr>
					...
					<td><input type="checkbox" name="Source[]" <?php if(whereExist("A Friend or Colleague")) echo "checked";?> value="A Friend or Colleague"> A Friend or Colleague<br>
					<input type="checkbox" name="Source[]" <?php if(whereExist("Google")) echo "checked";?> value="Google"> Google<br>
					<input type="checkbox" name="Source[]" <?php if(whereExist("Blog Post")) echo "checked";?> value="Blog Post"> Blog Post<br>
					<input type="checkbox" name="Source[]" <?php if(whereExist("News Article")) echo "checked";?> value="News Article"> News Article
					</td>
